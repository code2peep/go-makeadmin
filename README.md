...
本项目早期参考 LikeAdmin Go 的 MIT 开源实现，保留合法来源说明；当前已完成 P5，默认运行链路面向 `ma_*` 自研系统表和独立开发库 `go_makeadmin`。

## 当前阶段

P5 已冻结，下一阶段进入 P6：通用后台框架交付面和 AI 业务生成底座。
...
- P5 已完成 Demo Article 与 Demo Notice 多模块 registry 验收。
- P6 当前入口：保证通用后台框架能被打开、理解、生成和扩展；模块中心只保留为开发工具，不继续扩展成复杂模块市场。
...
P5 状态见 `docs/P5_STATUS.md`。P5.1 Demo Article 可见模块见 `docs/P5_DEMO_MODULE_VISIBLE.md`。P5.2 模块中心真实 apply 见 `docs/P5_MODULE_CENTER_APPLY.md`。P5.3 模块状态回读见 `docs/P5_MODULE_STATUS_READBACK.md`。P5.4 模块状态筛选见 `docs/P5_MODULE_STATUS_FILTERS.md`。P5.5 模块 registry 只读清单见 `docs/P5_MODULE_REGISTRY_READONLY.md`。P5.6 registry manifest 校验见 `docs/P5_MODULE_REGISTRY_MANIFEST_CHECK.md`。P5.7 registry 校验明细见 `docs/P5_MODULE_REGISTRY_CHECK_DETAIL.md`。P5.8 registry 异常 fixture 见 `docs/P5_MODULE_REGISTRY_FAILURE_FIXTURE.md`。P5.9 registry smoke 见 `docs/P5_MODULE_REGISTRY_SMOKE.md`。P5.10 registry 路由契约见 `docs/P5_MODULE_REGISTRY_ROUTE_CONTRACT.md`。P5.11 registry 验收矩阵见 `docs/P5_MODULE_REGISTRY_ACCEPTANCE_MATRIX.md`。P5.12 模块中心验收状态见 `docs/P5_MODULE_CENTER_ACCEPTANCE_STATUS.md`。P5.13 registry 页面状态见 `docs/P5_MODULE_CENTER_REGISTRY_STATES.md`。P5.14 registry 状态 helper 见 `docs/P5_MODULE_CENTER_REGISTRY_STATE_HELPER.md`。P5.15 registry 状态 fixture 见 `docs/P5_MODULE_CENTER_REGISTRY_STATE_FIXTURE.md`。P5.16 registry 文档索引见 `docs/P5_MODULE_REGISTRY_DOC_INDEX.md`。P5.17 模块中心人工验收清单见 `docs/P5_MODULE_CENTER_MANUAL_CHECKLIST.md`。P5.18 模块中心 UI 契约见 `docs/P5_MODULE_CENTER_UI_CONTRACT.md`。P5.19 registry 冻结清单见 `docs/P5_MODULE_REGISTRY_FREEZE_CHECKLIST.md`。P5.20 第二个示例模块见 `docs/P5_SECOND_DEMO_MODULE.md`。P5.21 Demo Notice 验收见 `docs/P5_DEMO_NOTICE_ACCEPTANCE.md`。P5.22 Demo Notice 状态契约见 `docs/P5_DEMO_NOTICE_STATUS_CONTRACT.md`。P5.23 多模块筛选见 `docs/P5_MODULE_CENTER_MULTI_FILTERS.md`。P5.24 多模块人工验收入口见 `docs/P5_MODULE_CENTER_MANUAL_MULTI_CHECKLIST.md`。P5 最终状态见 `docs/P5_FINAL_STATUS.md`。

P6 状态见 `docs/P6_STATUS.md`。P6.1 模块中心产品化入口见 `docs/P6_STATUS.md`。P6.2 模块详情弹窗见 `docs/P6_STATUS.md`。P6.3 通用后台框架交付面见 `docs/P6_STATUS.md`。P6.4 生成器业务模块模板体验见 `docs/P6_STATUS.md`。P6.5 通用后台人工可见链路见 `docs/P6_STATUS.md`。P6.6 菜单层级与目录空白页修整见 `docs/P6_STATUS.md`。P6.7 后台第一屏和侧边栏验收见 `docs/P6_STATUS.md`。P6.8 素材管理空态和上传入口见 `docs/P6_STATUS.md`。P6 最终状态见 `docs/P6_FINAL_STATUS.md`。
