...
本项目早期参考 LikeAdmin Go 的 MIT 开源实现，保留合法来源说明；当前 P1 已冻结，默认运行链路面向 `ma_*` 自研系统表和独立开发库 `go_makeadmin`。
...
本地启动链路见 `docs/LOCAL_DEV.md`。P1 验收清单见 `docs/P1_ACCEPTANCE_CHECKLIST.md`。P1 最终状态见 `docs/P1_FINAL_STATUS.md`。P1 数据模型设计见 `docs/P1_SCHEMA_PLAN.md`。
