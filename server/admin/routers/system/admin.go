...
func newAdminHandler(srv system.ISystemAuthAdminService, makeadminAdapter makeadminadapter.SystemAdapter) *adminHandler {
	return &adminHandler{srv: srv, makeadminAdapter: makeadminAdapter}
}
