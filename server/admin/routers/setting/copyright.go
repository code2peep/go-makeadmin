...
func newCopyrightHandler(makeadminCopyright makeadminadapter.CopyrightAdapter) *copyrightHandler {
	return &copyrightHandler{makeadminCopyright: makeadminCopyright}
}
