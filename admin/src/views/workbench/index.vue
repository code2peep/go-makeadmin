        ...
        <div class="md:flex">
            <el-card class="!border-none mb-4 md:mr-4" shadow="never">
                ...
                <div>
                    ...
                    <div class="flex leading-9">
                        <div class="w-20 flex-none">获取渠道</div>
                        <div>
                            <a :href="workbenchData.version.links.website" target="_blank">
                                <el-button type="success" size="small">官网</el-button>
                            </a>
                            <a class="ml-3" :href="workbenchData.version.links.gitee" target="_blank">
