...
echo "==> Module tools: business codegen template contract"
scripts/check-codegen-business-template-contract.sh >/dev/null

echo "==> Module tools: generated frontend type-check"
scripts/check-codegen-frontend.sh >/dev/null

echo "==> Module tools: manifest preview"
scripts/check-module-manifest-preview.sh >/dev/null

echo "==> Module tools: registry smoke"
scripts/check-module-registry-smoke.sh >/dev/null

echo "==> Module tools: module center UI contract"
scripts/check-module-center-ui-contract.sh >/dev/null

echo "==> Module tools: demo notice module contract"
scripts/check-demo-notice-module.sh >/dev/null
...
echo "==> Module tools: P5 module center freeze contract"
scripts/check-p5-module-center-freeze.sh >/dev/null
...
echo "==> Module tools: uninstall apply boundary"
scripts/check-module-uninstall-apply-boundary.sh >/dev/null
